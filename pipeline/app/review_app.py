# -*- coding: utf-8 -*-
"""Interface de revue des verdicts de classification (Streamlit).

Affiche pour chaque thèse : classification actuelle vs suggérée, candidats,
justification et extrait du texte ; permet de valider ou corriger, la décision
étant enregistrée dans PostgreSQL (resultats.decision_humaine).
"""
...
st.set_page_config(page_title="Revue classification ACIEGE", layout="wide")
st.title("📚 Revue de classification — thésaurus ACIEGE")
